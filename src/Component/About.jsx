...
const About = () => {
    ...
    return (
        <div  className="about" id='About'>
            ...
            <div className='cover'>
            <div class="card">
                <div class="bg"><img src="https://res.cloudinary.com/dhd5do52g/image/upload/v1738264852/openart-image_UY2YJvFs_1738264052962_raw_debc4r.jpg" className='about-image' alt="" /></div>
                <div class="blob"></div>
            </div>
            ...
            <div className='about-para'>
                  <div className='para'>
                  <GoDotFill size={30} />
                  <p>Hello! My name is Surya Kiran Majhi, and I have a deep passion for building dynamic and
